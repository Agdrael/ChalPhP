...
<body>
        ...
        <div class="panel-body">
            <div class="table-responsive">
                ...
                <table id="data-table-keytable" width="100%" class="table table-striped table-bordered align-middle text-nowrap">
                    ...
                    <tbody>
                        <?php
                        $sentencia = $pdo->query("SELECT * FROM catalogo WHERE Cuenta LIKE '1105%' and terminal = 'T' and (nivel = 7 OR nivel= 6) ORDER BY descripcion ASC;");
                        $sentencia->execute();
    ...
    <script>
        function LlenarActividad(codigo, nombre) {
            window.opener.Recibir_Inv(codigo, nombre);
            window.close();
        }
    </script>
</body>